...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("14/03/2024"), "Partiu São Paulo", "Bora ver o Coringão jogar", maria);
		Post post2 = new Post(null, sdf.parse("15/03/2024"), "Bom dia", "Hoje o dia está maravilhoso", maria);
